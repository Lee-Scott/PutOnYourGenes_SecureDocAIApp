        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <div className="flex-shrink-0 dropdown">
              <button className="d-block link-body-emphasis text-decoration-none dropdown-toggle profile-dropdown" style={{cursor: 'pointer', background: 'none', border: 'none'}}
              ...
              <ul className="dropdown-menu dropdown-menu-end" style={{paddingInline: '10px'}}>
                ...
                <hr className="dropdown-divider" />
                <li>
                  <button onClick={onLogout} className="rounded-2 dropdown-item dropdown-item-danger d-flex gap-2 align-items-center" style={{cursor: 'pointer'}}>
